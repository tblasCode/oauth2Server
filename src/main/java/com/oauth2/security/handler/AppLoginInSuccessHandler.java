...
public class AppLoginInSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        ...
        if (clientDetails == null) {
            throw new UnapprovedClientAuthenticationException("clientId The corresponding configuration information does not exist" + clientId);
        } else if (!StringUtils.equals(clientDetails.getClientSecret(), clientSecret)) {
            throw new UnapprovedClientAuthenticationException("clientSecret Mismatch" + clientId);
        }
